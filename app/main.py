...
from routers.service_demonstration import router as service_demon
from routers.dependency_demon import router as service_dep
@asynccontextmanager
...
app.include_router(service_demon)
app.include_router(service_dep)